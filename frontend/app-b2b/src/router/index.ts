...
export default createRouter({ history: createWebHistory(), routes: [{
  path: '/merchant', component: () => import('../layouts/Default.vue'), children: [
    ...
    { path: 'shop/settings', name:'shopSettings', component: () => import('../pages/shop/SettingsPage.vue') },
    { path: 'coupons', name:'merchantCoupons', component: () => import('../pages/coupons/CouponPage.vue') },
    { path: 'seckill', name:'merchantSeckill', component: () => import('../pages/seckill/SeckillPage.vue') },
    { path: 'reviews', name:'merchantReviews', component: () => import('../pages/reviews/ReviewPage.vue') },
    { path: 'notifications', name:'merchantNotify', component: () => import('../pages/notifications/NotifyPage.vue') },
